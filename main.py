...
#example
coordinates = (4, 5)
# get the first element in the above yuple
print(coordinates[1])
...
print (len(my_tuple))
my_tuple3 = (1,2,3,3,4,5,7,7,7,8,8)
print(my_tuple3.count(7))
my_tuple4 = ('a','a','a','b','b','c')
...
#################################################sets######################################################
# sets are mutal data structure for storing information whose elements do not repeat
